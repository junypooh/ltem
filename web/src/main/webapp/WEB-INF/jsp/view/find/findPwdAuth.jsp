    ...
    <div class="wrap_member">
        <div>
            <section class="box_login">
                ...
                <form:form action="${pageContext.request.contextPath}/find/findPwdCheck" method="POST" commandName="findAccountInfo" id="frm">
                    <form:hidden path="id" />
                <div class="area_inp">
                    <ul>
                        <li>
                            <div class="inp_mem" id="divName"><form:input path="name" title="이름"
                                                                          placeholder="이름"/></div>
                        ...
                        <li>
                            <div class="inp_mem numchk2">
                                <form:input path="authenticationNumber" title="인증번호" cssClass="inp_numchk"
                                            placeholder="인증번호"/>
...
<script type="text/javascript">
    ...
    function confirm() {
        ...
        if(!$("input[name='authenticationNumber']").val()) {
            $(".btn_phok").after('<span class="txt_des">인증번호를 입력해주세요.</span>');
            $("input[name='authenticationNumber']").focus();
            return false;
        }
